...
class BaseViewController: UIViewController {
    ...
    func getHeaderLabel(title:String) -> UILabel{
        let w = title.width(forHeight: 25, font: UIFont(name: "Sen-ExtraBold", size: 23)!)
        let label = UILabel(frame: CGRect(x: 0, y: 0, width: w, height: 20))
        label.text = title
        label.font = UIFont(name: "Sen-ExtraBold", size: 23)
    ...
    func getGradientHeaderLabel(title:String) -> UILabel{
        let w = title.width(forHeight: 25, font: UIFont(name: "Sen-Bold", size: 23)!)
        let label = UILabel(frame: CGRect(x: 0, y: 0, width: w, height: 20))
        label.text = title
        label.font = UIFont(name: "Sen-Bold", size: 23)
